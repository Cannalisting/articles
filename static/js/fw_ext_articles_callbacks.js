...
jQuery(document).on('ready', function () {
	...
	var cannalisting_featured_nounce	= fw_ext_articles_scripts_vars.cannalisting_featured_nounce;
    ...
    jQuery(document).on('click', '.process-article', function (e) {
        ...
        var dataString = 'type=' + _type + '&' + serialize_data + '&action=fw_ext_cannalisting_process_articles';
                ...
                'Yes': {
                    ...
                    'action': function () {
                        ...
                        jQuery.ajax({
                            type: "POST",
                            url: fw_ext_articles_scripts_vars.ajaxurl,
                            data: 'id=' + _id + '&action=fw_ext_cannalisting_delete_articles',
                            dataType: "json",
                            success: function (response) {
                                jQuery('body').find('.provider-site-wrap').remove();
	...
	var uploader = new plupload.Uploader({
		...
		file_data_name: 'cannalisting_uploader',
		...
		url: fw_ext_articles_scripts_vars.ajaxurl + "?action=cannalisting_featured_image_uploader&nonce=" + cannalisting_featured_nounce,
		filters: {
			mime_types : [
	...
	uploader.bind('UploadProgress', function(up, file) {
		...
		cannalisting_uploader_progressbar(file.percent,'add');
	});
	...
	uploader.bind('FileUploaded', function ( up, file, ajax_response ) {
		...
		cannalisting_uploader_progressbar('','remove');
	});
