...
/**
 *
 * cannalisting display author articles..
 *
...
$username	= '';
if( function_exists('cannalisting_get_username') ){
	$username = cannalisting_get_username($post_author_id);
}
...
if ($query->have_posts()) :?>
    <div class="tg-widget tg-widgetrelatedposts sp-provider-articles" id="section-articles">
        <div class="tg-widgettitle">
            <h3><?php esc_html_e('Articles', 'cannalisting_core'); ?>&nbsp;<span class="written-by-sp"><?php esc_html_e('Written by', 'cannalisting_core'); ?>&nbsp;<?php echo esc_attr( $username );?></span></h3>
        </div>
                        ...
                        <div class="tg-serviceprovidercontent">
                            <?php if (!empty($thumbnail)) { ?>
                                <div class="tg-companylogo">
                                    <a href="<?php echo esc_url(get_permalink()); ?>">
                                        <img src="<?php echo esc_url($thumbnail); ?>" alt="<?php esc_html_e('Related', 'cannalisting_core'); ?>">
                                    </a>
                                </div>
                            <?php } ?>
                            <div class="tg-companycontent">
                                ...
                                <ul class="tg-matadata">
                                    <li><a href="<?php echo esc_url(get_permalink()); ?>">  <?php esc_html_e('Read More', 'cannalisting_core'); ?> </a> </li>
                                </ul>
                            </div>
                        </div>
                    </li>
