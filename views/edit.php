...
$content = esc_html__('Article detail will be here', 'cannalisting_core');
...
<div id="tg-content" class="tg-content edit-mode">
    <div class="tg-dashboardbox tg-businesshours">
        ...
        if (intval($url_identity) === intval($post_author)) {
            if (isset($status) && $status === 'publish') {
                ...
                while ($query->have_posts()) : $query->the_post();
                    ...
                    <div class="tg-dashboardtitle">
                        <h2><?php esc_html_e('Edit Article', 'cannalisting_core'); ?></h2>
                    </div>
                            ...
                            <form class="tg-themeform tg-formamanagejobs tg-addarticle sp-dashboard-profile-form">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pull-left">
                                            <div class="form-group">
                                                <input type="text" value="<?php the_title(); ?>" name="article_title" class="form-control" placeholder="<?php esc_html_e('Article Title', 'cannalisting_core'); ?>">
                                ...
                                <fieldset>
                                    <div id="tg-updateall" class="tg-updateall">
                                        <div class="tg-holder">
                                            <span class="tg-note"><?php esc_html_e('Click to', 'cannalisting_core'); ?> <strong> <?php esc_html_e('Update Article Button', 'cannalisting_core'); ?> </strong> <?php esc_html_e('to update the article.', 'cannalisting_core'); ?></span>
                                            <?php wp_nonce_field('cannalisting_article_nounce', 'cannalisting_article_nounce'); ?>
                                            <a class="tg-btn process-article" data-type="update" href="javascript:;"><?php esc_html_e('Update Article', 'cannalisting_core'); ?></a>
                                        </div>
                                    </div>
                                </fieldset>
                            </form>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <?php cannalisting_Prepare_Notification::cannalisting_warning(esc_html__('Restricted Access', 'cannalisting_core'), esc_html__('This article needs to be approve/publish to update.', 'cannalisting_core')); ?>
                </div>
                <?php
            }
        } else {
            ?>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <?php cannalisting_Prepare_Notification::cannalisting_warning(esc_html__('Restricted Access', 'cannalisting_core'), esc_html__('You have not any privilege to view this page.', 'cannalisting_core')); ?>
            </div>
        <?php } ?>
    </div>
</div>
