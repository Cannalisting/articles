			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class="tg-companyfeaturetitle">
						<h3><?php esc_html_e('Articles', 'cannalisting_core'); ?></h3>
					</div>
						  ...
						  <article class="tg-newsarticle">
							...
							<figure class="tg-newsimg"> 
								<a href="<?php echo esc_url(get_permalink()); ?>">
									<img src="<?php echo esc_url($thumbnail); ?>" alt="<?php esc_html_e('article', 'cannalisting_core'); ?>">
								</a>
							</figure>
							<?php } ?>
							...
							<ul class="tg-postarticlemeta">
							  <li><span>
								<time datetime="2020-01-01"><?php cannalisting_get_post_date($post->ID); ?></time>
								</span></li>
							</ul>
						  </article>
						</div>
